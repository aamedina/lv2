...
(def Event
  ...
  {:db/ident        :lv2.ev/Event,
   ...
   :rdfs/label      "Event",
   :rdfs/subClassOf [:rdfs/Resource :lv2.ev/Event]})
...
(def EventPort
  ...
  {:db/ident        :lv2.ev/EventPort,
   ...
   :rdfs/subClassOf [:rdfs/Resource :lv2/Port :lv2.ev/EventPort]})
...
(def FrameStamp
  ...
  {:db/ident        :lv2.ev/FrameStamp,
   ...
   :rdfs/subClassOf [:lv2.ev/TimeStamp :lv2.ev/FrameStamp :rdfs/Resource]})
...
(def TimeStamp
  ...
  {:db/ident        :lv2.ev/TimeStamp,
   ...
   :rdfs/subClassOf [:rdfs/Resource :lv2.ev/TimeStamp]})
...
(def generatesTimeStamp
  ...
  {:db/ident           :lv2.ev/generatesTimeStamp,
   ...
   :rdfs/subPropertyOf :lv2.ev/generatesTimeStamp})
...
(def inheritsEvent
  ...
  {:db/ident           :lv2.ev/inheritsEvent,
   ...
   :rdfs/range         :lv2/Port,
   :rdfs/subPropertyOf :lv2.ev/inheritsEvent})
...
(def inheritsTimeStamp
  ...
  {:db/ident :lv2.ev/inheritsTimeStamp,
   ...
   :rdfs/range :lv2/Port,
   :rdfs/subPropertyOf :lv2.ev/inheritsTimeStamp})
...
(def supportsEvent
  ...
  {:db/ident           :lv2.ev/supportsEvent,
   ...
   :rdfs/range         :rdfs/Class,
   :rdfs/subPropertyOf :lv2.ev/supportsEvent})
