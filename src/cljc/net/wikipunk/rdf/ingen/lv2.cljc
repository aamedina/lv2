...
(def ^{:private true} GraphPrototype
  ...
  {:db/ident :ingen/GraphPrototype,
   :lv2/binary {:rdfa/uri "https://gitlab.com/drobilla/ingen/-/raw/master/bundles/ingen.lv2/libingen_lv2.so"},
...
(def ^{:private true} GraphUIGtk2
  ...
  {:db/ident      :ingen/GraphUIGtk2,
   :lv2.ui/binary {:rdfa/uri "https://gitlab.com/drobilla/ingen/-/raw/master/bundles/ingen.lv2/libingen_gui_lv2.so"},
