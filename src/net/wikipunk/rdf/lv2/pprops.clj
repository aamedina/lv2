...
(def causesArtifacts
  ...
  {:db/ident     :pprops/causesArtifacts,
...
(def displayPriority
  ...
  {:db/ident     :pprops/displayPriority,
...
(def hasStrictBounds
  ...
  {:db/ident     :pprops/hasStrictBounds,
   :rdf/type     :lv2/PortProperty,
...
(def supportsStrictBounds
  ...
  {:db/ident     :pprops/supportsStrictBounds,
