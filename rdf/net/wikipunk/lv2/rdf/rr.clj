...
(def PredicateObjectMap
  ...
  {:rdf/about       :rr/PredicateObjectMap,
   :rdf/type        :owl/Class,
   :rdfs/comment    {:rdf/language "en",
...
(def R2RMLView
  {:rdf/about       :rr/R2RMLView,
   :rdf/type        :owl/Class,
   :rdfs/subClassOf :rr/LogicalTable})

(def RefObjectMap
  "Denotes a reference to an object map."
  {:rdf/about       :rr/RefObjectMap,
   :rdf/type        :owl/Class,
   :rdfs/comment    {:rdf/language "en",
...
(def inverseExpression
  ...
  {:rdf/about :rr/inverseExpression,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
