(ns net.wikipunk.lv2.rdf.ia
  ...
  {:dcat/downloadURL
   ...
   :lv2/project {:doap/created "2010-10-04",
                 :doap/developer "http://drobilla.net/drobilla#me",
                 :doap/license "http://opensource.org/licenses/isc",
                 :doap/name "LV2 Instance Access",
                 :doap/shortdesc
                 "Provides access to the LV2_Handle of a plugin.",
                 :rdf/about "http://lv2plug.in/ns/ext/instance-access",
