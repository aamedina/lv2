(ns net.wikipunk.lv2.rdf.vann
  ...
  {:dcat/downloadURL              "https://vocab.org/vann/vann-vocab-20100607.rdf",
   ...
   :dcterms/isVersionOf           "http://purl.org/vocab/vann/",
   ...
   :rdf/about                     "http://purl.org/vocab/vann/",
...
(def preferredNamespacePrefix
  ...
  {:rdf/about        :vann/preferredNamespacePrefix,
   :rdf/type         :owl/AnnotationProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def preferredNamespaceUri
  ...
  {:rdf/about        :vann/preferredNamespaceUri,
   :rdf/type         :owl/AnnotationProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
