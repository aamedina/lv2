(ns net.wikipunk.lv2.rdf.jsonld
  ...
  {:owl/versionInfo
   ...
   "http://purl.org/dc/terms/date" #inst "2020-03-30T00:00:00.000-04:00",
   "http://purl.org/dc/terms/description"
   {:rdf/language "en",
    :rdf/value
    "This is a vocabulary document and is used to achieve certain features of the JSON-LD language."},
   "http://purl.org/dc/terms/title" {:rdf/language "en",
...
(def PrefixDefinition
  ...
  {:rdf/about :jsonld/PrefixDefinition,
   :rdf/type :rdfs/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def TermDefinition
  ...
  {:rdf/about :jsonld/TermDefinition,
   :rdf/type :rdfs/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def graphContainerType
  ...
  {:rdf/about :jsonld/graphContainerType,
...
(def idContainerType
  "If the [expanded term definition](https://www.w3.org/TR/json-ld11/#dfn-expanded-term-definitions) contains the `@container` keyword, its value MUST be either `@list`, `@set`, `@language`, `@index`, `@id`, `@graph`, `@type`, or be `null` or an _array_ containing exactly any one of those keywords."
  {:rdf/about :jsonld/idContainerType,
   :rdf/type "http://www.w3.org/ns/ContainerType",
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def indexContainerType
  "If the [expanded term definition](https://www.w3.org/TR/json-ld11/#dfn-expanded-term-definitions) contains the `@container` keyword, its value MUST be either `@list`, `@set`, `@language`, `@index`, `@id`, `@graph`, `@type`, or be `null` or an _array_ containing exactly any one of those keywords."
  {:rdf/about :jsonld/indexContainerType,
   :rdf/type "http://www.w3.org/ns/ContainerType",
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def languageContainerType
  "If the [expanded term definition](https://www.w3.org/TR/json-ld11/#dfn-expanded-term-definitions) contains the `@container` keyword, its value MUST be either `@list`, `@set`, `@language`, `@index`, `@id`, `@graph`, `@type`, or be `null` or an _array_ containing exactly any one of those keywords."
  {:rdf/about :jsonld/languageContainerType,
   :rdf/type "http://www.w3.org/ns/ContainerType",
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def listContainerType
  "If the [expanded term definition](https://www.w3.org/TR/json-ld11/#dfn-expanded-term-definitions) contains the `@container` keyword, its value MUST be either `@list`, `@set`, `@language`, `@index`, `@id`, `@graph`, `@type`, or be `null` or an _array_ containing exactly any one of those keywords."
  {:rdf/about :jsonld/listContainerType,
   :rdf/type "http://www.w3.org/ns/ContainerType",
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def setContainerType
  "If the [expanded term definition](https://www.w3.org/TR/json-ld11/#dfn-expanded-term-definitions) contains the `@container` keyword, its value MUST be either `@list`, `@set`, `@language`, `@index`, `@id`, `@graph`, `@type`, or be `null` or an _array_ containing exactly any one of those keywords."
  {:rdf/about :jsonld/setContainerType,
   :rdf/type "http://www.w3.org/ns/ContainerType",
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def typeContainerType
  "If the [expanded term definition](https://www.w3.org/TR/json-ld11/#dfn-expanded-term-definitions) contains the `@container` keyword, its value MUST be either `@list`, `@set`, `@language`, `@index`, `@id`, `@graph`, `@type`, or be `null` or an _array_ containing exactly any one of those keywords."
  {:rdf/about :jsonld/typeContainerType,
   :rdf/type "http://www.w3.org/ns/ContainerType",
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
