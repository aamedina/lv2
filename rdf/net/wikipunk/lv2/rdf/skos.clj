(ns net.wikipunk.lv2.rdf.skos
  ...
  {:dcterms/contributor
   ...
   :rdf/about "http://www.w3.org/2004/02/skos/core",
...
(def OrderedCollection
  ...
  {:rdf/about :skos/OrderedCollection,
   :rdf/type :owl/Class,
   :rdfs/isDefinedBy "http://www.w3.org/2004/02/skos/core",
   :rdfs/label {:rdf/language "en",
...
(def broaderTransitive
  ...
  {:owl/inverseOf :skos/narrowerTransitive,
   :rdf/about :skos/broaderTransitive,
...
(def mappingRelation
  ...
  {:rdf/about :skos/mappingRelation,
   :rdf/type [:rdf/Property :owl/ObjectProperty],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def narrowerTransitive
  ...
  {:owl/inverseOf :skos/broaderTransitive,
   :rdf/about :skos/narrowerTransitive,
   :rdf/type [:rdf/Property :owl/TransitiveProperty :owl/ObjectProperty],
   :rdfs/isDefinedBy "http://www.w3.org/2004/02/skos/core",
   :rdfs/label {:rdf/language "en",
...
(def semanticRelation
  ...
  {:rdf/about :skos/semanticRelation,
   :rdf/type [:rdf/Property :owl/ObjectProperty],
