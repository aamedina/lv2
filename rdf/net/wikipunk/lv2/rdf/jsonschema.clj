(ns net.wikipunk.lv2.rdf.jsonschema
  "JSON Schema in RDF"
  {:dcterms/creator "https://vcharpenay.link/#me",
   ...
   :rdf/about "https://www.w3.org/2019/wot/json-schema#",
...
(def ArraySchema
  ...
  {:rdf/about :jsonschema/ArraySchema,
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def BooleanSchema
  ...
  {:rdf/about :jsonschema/BooleanSchema,
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def DataSchema
  ...
  {:rdf/about :jsonschema/DataSchema,
   :rdf/type :owl/Class,
   :rdfs/comment
   "Metadata that describes the data format used. It can be used for validation."})
...
(def IntegerSchema
  ...
  {:rdf/about :jsonschema/IntegerSchema,
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def NullSchema
  ...
  {:rdf/about :jsonschema/NullSchema,
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def NumberSchema
  ...
  {:rdf/about :jsonschema/NumberSchema,
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def ObjectSchema
  ...
  {:rdf/about :jsonschema/ObjectSchema,
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def StringSchema
  ...
  {:rdf/about :jsonschema/StringSchema,
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def contentEncoding
  ...
  {:rdf/about :jsonschema/contentEncoding,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def contentMediaType
  ...
  {:rdf/about :jsonschema/contentMediaType,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def exclusiveMaximum
  ...
  {:rdf/about :jsonschema/exclusiveMaximum,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def exclusiveMinimum
  ...
  {:rdf/about :jsonschema/exclusiveMinimum,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def maxLength
  ...
  {:rdf/about :jsonschema/maxLength,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def minLength
  ...
  {:rdf/about :jsonschema/minLength,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def multipleOf
  ...
  {:rdf/about :jsonschema/multipleOf,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def properties
  ...
  {:rdf/about            :jsonschema/properties,
   :rdf/type             :owl/ObjectProperty,
   :rdfs/comment         {:rdf/language "en",
...
(def propertyName
  ...
  {:rdf/about :jsonschema/propertyName,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def writeOnly
  ...
  {:rdf/about :jsonschema/writeOnly,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
