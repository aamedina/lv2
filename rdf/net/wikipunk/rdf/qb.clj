(ns net.wikipunk.rdf.qb
  ...
  {:dcterms/contributor [{:foaf/mbox "ian@epimorphics.com"}
   ...
   "Vocabulary for multi-dimensional (e.g. statistical) data publishing",
   :owl/versionInfo "0.2",
   :rdf/about "http://purl.org/linked-data/cube",
...
(def AttributeProperty
  ...
  {:owl/disjointWith :qb/MeasureProperty,
   :rdf/about :qb/AttributeProperty,
   :rdf/type [:owl/Class :rdfs/Class],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def ComponentProperty
  ...
  {:rdf/about :qb/ComponentProperty,
   :rdf/type [:owl/Class :rdfs/Class],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def ComponentSpecification
  ...
  {:rdf/about :qb/ComponentSpecification,
   :rdf/type [:owl/Class :rdfs/Class],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def DataStructureDefinition
  ...
  {:rdf/about        :qb/DataStructureDefinition,
   :rdf/type         [:owl/Class :rdfs/Class],
   :rdfs/comment     {:rdf/language "en",
...
(def DimensionProperty
  ...
  {:owl/disjointWith :qb/MeasureProperty,
   :rdf/about :qb/DimensionProperty,
   :rdf/type [:owl/Class :rdfs/Class],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def HierarchicalCodeList
  ...
  {:rdf/about :qb/HierarchicalCodeList,
   :rdf/type [:owl/Class :rdfs/Class],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def componentAttachment
  ...
  {:rdf/about :qb/componentAttachment,
...
(def componentRequired
  ...
  {:rdf/about :qb/componentRequired,
...
(def parentChildProperty
  ...
  {:rdf/about :qb/parentChildProperty,
   :rdf/type [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
