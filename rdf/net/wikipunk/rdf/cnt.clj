(ns net.wikipunk.rdf.cnt
  ...
  {:owl/imports "http://purl.org/dc/terms/",
   ...
   :rdf/about "http://www.w3.org/2011/content",
...
(def characterEncoding
  ...
  {:rdf/about :cnt/characterEncoding,
   :rdf/type [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def declaredEncoding
  ...
  {:rdf/about    :cnt/declaredEncoding,
   :rdf/type     [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment {:rdf/language "en",
                  :rdf/value
                  "The character encoding declared in the XML declaration."},
