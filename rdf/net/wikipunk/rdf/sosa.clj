...
(def ActuatableProperty
  ...
  {:rdf/about :sosa/ActuatableProperty,
...
(def FeatureOfInterest
  ...
  {:rdf/about :sosa/FeatureOfInterest,
   :rdf/type [:owl/Class :rdfs/Class],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def ObservableProperty
  ...
  {:rdf/about :sosa/ObservableProperty,
   :rdf/type [:owl/Class :rdfs/Class],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def hasFeatureOfInterest
  ...
  {:owl/inverseOf :sosa/isFeatureOfInterestOf,
   :rdf/about :sosa/hasFeatureOfInterest,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def hasSimpleResult
  ...
  {:rdf/about :sosa/hasSimpleResult,
...
(def isFeatureOfInterestOf
  ...
  {:owl/inverseOf :sosa/hasFeatureOfInterest,
   :rdf/about :sosa/isFeatureOfInterestOf,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def madeObservation
  ...
  {:owl/inverseOf :sosa/madeBySensor,
   :rdf/about :sosa/madeObservation,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def observedProperty
  ...
  {:rdf/about :sosa/observedProperty,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
