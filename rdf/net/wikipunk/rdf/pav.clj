...
(def hasCurrentVersion
  ...
  {:rdf/about :pav/hasCurrentVersion,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def hasEarlierVersion
  ...
  {:rdf/about :pav/hasEarlierVersion,
   :rdf/type
...
(def sourceAccessedAt
  ...
  {:rdf/about :pav/sourceAccessedAt,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def sourceAccessedBy
  ...
  {:rdf/about :pav/sourceAccessedBy,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def sourceAccessedOn
  ...
  {:owl/equivalentProperty [:pav1/sourceAccessedOn :pav1/sourceFirstAccessedOn],
   :rdf/about :pav/sourceAccessedOn,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def sourceLastAccessedOn
  ...
  {:owl/equivalentProperty :pav1/sourceLastAccessedOn,
   :rdf/about :pav/sourceLastAccessedOn,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
