...
(def administrator_of
  ...
  {:owl/inverseOf    :sioc/has_administrator,
   :rdf/about        :sioc/administrator_of,
   :rdf/type         :owl/ObjectProperty,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value
                      "A Site that the UserAccount is an administrator of."},
...
(def content_encoded
  ...
  {:owl/versionInfo
   ...
   :rdf/about :sioc/content_encoded,
...
(def earlier_version
  ...
  {:owl/inverseOf :sioc/later_version,
   :rdf/about :sioc/earlier_version,
...
(def embeds_knowledge
  ...
  {:rdf/about :sioc/embeds_knowledge,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def has_administrator
  ...
  {:owl/inverseOf    :sioc/administrator_of,
   :rdf/about        :sioc/has_administrator,
   :rdf/type         :owl/ObjectProperty,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value
                      "A UserAccount that is an administrator of this Site."},
...
(def last_activity_date
  ...
  {:rdf/about :sioc/last_activity_date,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def last_reply_date
  ...
  {:rdf/about :sioc/last_reply_date,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def previous_by_date
  ...
  {:owl/inverseOf :sioc/next_by_date,
   :rdf/about :sioc/previous_by_date,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value
                  "Previous Item or Post in a given Container sorted by date."},
...
(def previous_version
  ...
  {:owl/inverseOf      :sioc/next_version,
   :rdf/about          :sioc/previous_version,
   :rdf/type           :owl/ObjectProperty,
   :rdfs/comment       {:rdf/language "en",
                        :rdf/value
                        "Links to the previous revision of this Item or Post."},
