(ns net.wikipunk.rdf.ao
  "The Association Ontology specification provides basic properties  for describing specific associations to something, e.g. a context, an occasion, a genre or a mood, and enables furthermore, a mechanism to  like/rate and feedback these associations in context to something on/ for the Semantic Web. This document contains a RDF description  of the Association Ontology."
  {:dcat/downloadURL "https://purl.org/ontology/ao/associationontology.owl",
   :dcterms/creator ["http://foaf.me/zazi#me" "http://tobyinkster.co.uk/#i"],
   :dcterms/date #inst "2010-09-13T12:59:52.000-00:00",
   :dcterms/description
   {:rdf/language "en",
    :rdf/value
   ...
   :rdf/about "http://purl.org/ontology/ao/core#",
...
(def LikeableAssociation
  ...
  {:rdf/about :ao/LikeableAssociation,
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def included_association
  ...
  {:owl/inverseOf {:rdf/type   :owl/ObjectProperty,
   ...
   :rdf/about :ao/included_association,
