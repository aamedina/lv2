...
(def AssetDistribution
  ...
  {:dcterms/identifier "adms:AssetDistribution",
   :rdf/about :adms/AssetDistribution,
   :rdf/type :rdfs/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def AssetRepository
  ...
  {:dcterms/identifier "adms:AssetRepository",
   :rdf/about :adms/AssetRepository,
   :rdf/type :rdfs/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def interoperabilityLevel
  ...
  {:dcterms/identifier "adms:interoperabilityLevel",
   :rdf/about :adms/interoperabilityLevel,
   :rdf/type [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def representationTechnique
  ...
  {:dcterms/identifier "adms:representationTechnique",
   :rdf/about :adms/representationTechnique,
   :rdf/type [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def supportedSchema
  ...
  {:dcterms/identifier "adms:supportedSchema",
   :rdf/about :adms/supportedSchema,
   :rdf/type [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
