  ...
  {:dcterms/contributor
   [{:foaf/homepage "http://makxdekkers.com/",
    ...
    {:foaf/name       "David Browning",
     :sdo/affiliation {:foaf/homepage "http://www.refinitiv.com",
                       :foaf/name     "Refinitiv"}}
    {:foaf/name       "Rufus Pollock",
     :sdo/affiliation {:foaf/homepage "http://okfn.org",
    ...
    {:foaf/homepage   "https://agbeltran.github.io",
     ...
     :sdo/affiliation {:foaf/homepage "http://stfc.ac.uk",
                       :foaf/name
    ...
    {:foaf/name       "Vassilios Peristeras",
     :sdo/affiliation {:foaf/homepage "http://ec.europa.eu/dgs/informatics/",
...
(def DataService
  ...
  {:rdf/about :dcat/DataService,
   ...
   :rdfs/subClassOf [:dctype/Service :dcat/Resource],
...
(def accessService
  ...
  {:rdf/about :dcat/accessService,
   ...
   :skos/changeNote [{:rdf/language "cs",
...
(def accessURL
  ...
  {:owl/propertyChainAxiom [:dcat/accessService :dcat/endpointURL],
   ...
   [{:rdf/language "en",
    ...
    {:rdf/language "ja",
     :rdf/value "データセットの配信にアクセス権を与えるランディング・ページ、フィード、SPARQLエンドポイント、その他の種類の資源。"}
    {:rdf/language "fr",
     :rdf/value
...
(def byteSize
  ...
  {:rdf/about :dcat/byteSize,
   :rdf/type [:owl/DatatypeProperty :rdf/Property],
   :rdfs/comment [{:rdf/language "ar",
   ...
   :rdfs/range :rdfs/Literal,
   :skos/definition [{:rdf/language "el",
                      :rdf/value    "Το μέγεθος μιας διανομής σε bytes."}
                     {:rdf/language "da",
                      :rdf/value
...
(def endpointDescription
  ...
  {:rdf/about :dcat/endpointDescription,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   [{:rdf/language "da",
     :rdf/value
...
(def qualifiedRelation
  ...
  {:rdf/about :dcat/qualifiedRelation,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   [{:rdf/language "cs",
     :rdf/value    "Odkaz na popis vztahu s jiným zdrojem."}
    {:rdf/language "it",
     :rdf/value "Link a una descrizione di una relazione con un'altra risorsa."}
    {:rdf/language "en",
     :rdf/value
     "Link to a description of a relationship with another resource."}
    {:rdf/language "es",
...
(def servesDataset
  ...
  {:rdf/about :dcat/servesDataset,
   ...
   [{:rdf/language "es",
    ...
    {:rdf/language "cs",
     :rdf/value "Kolekce dat, kterou je tato Datová služba schopna poskytnout."}
    {:rdf/language "en",
...
(def spatialResolutionInMeters
  ...
  {:rdf/about :dcat/spatialResolutionInMeters,
...
(def temporalResolution
  ...
  {:rdf/about :dcat/temporalResolution,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   [{:rdf/language "en",
...
(def themeTaxonomy
  ...
  {:rdf/about :dcat/themeTaxonomy,
   ...
   :rdfs/range :rdfs/Resource,
   :sdo/rangeIncludes [:skos/ConceptScheme :owl/Ontology :skos/Collection],
   :skos/altLabel {:rdf/language "da",
