...
(def FormalOrganization
  ...
  {:rdf/about :org/FormalOrganization,
   :rdf/type [:rdfs/Class :owl/Class],
   :rdfs/comment
   [{:rdf/language "es",
     :rdf/value
...
(def OrganizationalCollaboration
  ...
  {:owl/equivalentClass {:owl/intersectionOf [:org/Organization
                         ...
                         :rdf/type :owl/Class},
   :rdf/about :org/OrganizationalCollaboration,
   :rdf/type [:rdfs/Class :owl/Class],
   :rdfs/comment
   [{:rdf/language "ja",
     :rdf/value
...
(def OrganizationalUnit
  ...
  {:rdf/about :org/OrganizationalUnit,
   :rdf/type [:rdfs/Class :owl/Class],
   :rdfs/comment
   [{:rdf/language "en",
     :rdf/value
...
(def hasRegisteredSite
  ...
  {:rdf/about :org/hasRegisteredSite,
   :rdf/type [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment
   [{:rdf/language "ja",
     :rdf/value
...
(def hasSubOrganization
  ...
  {:owl/inverseOf :org/subOrganizationOf,
   :rdf/about :org/hasSubOrganization,
   :rdf/type [:rdf/Property :owl/ObjectProperty],
   :rdfs/comment
   [{:rdf/language "en",
     :rdf/value
...
(def originalOrganization
  ...
  {:owl/inverseOf :org/changedBy,
   :rdf/about :org/originalOrganization,
   :rdf/type [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment
   [{:rdf/language "it",
     :rdf/value
...
(def resultingOrganization
  ...
  {:owl/inverseOf :org/resultedFrom,
   :rdf/about :org/resultingOrganization,
   :rdf/type [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment
   [{:rdf/language "es",
     :rdf/value
...
(def subOrganizationOf
  ...
  {:owl/inverseOf :org/hasSubOrganization,
   :rdf/about :org/subOrganizationOf,
   :rdf/type [:rdf/Property :owl/ObjectProperty],
   :rdfs/comment
   [{:rdf/language "it",
     :rdf/value
...
(def transitiveSubOrganizationOf
  ...
  {:rdf/about :org/transitiveSubOrganizationOf,
