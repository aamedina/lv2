...
(def DatasetOccurrences
  ...
  {:rdf/about :voaf/DatasetOccurrences,
   :rdf/type :owl/Class,
   :rdfs/comment
   [{:rdf/language "fr",
     :rdf/value
...
(def VocabularySpace
  ...
  {:rdf/about :voaf/VocabularySpace,
   :rdf/type :owl/Class,
   :rdfs/comment
   [{:rdf/language "fr",
     :rdf/value
...
(def hasDisjunctionsWith
  ...
  {:dcterms/description
   ...
   :rdf/about :voaf/hasDisjunctionsWith,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   [{:rdf/language "en",
     :rdf/value
...
(def hasEquivalencesWith
  ...
  {:dcterms/description
   ...
   :rdf/about :voaf/hasEquivalencesWith,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   [{:rdf/language "fr",
     :rdf/value
...
(def occurrencesInDatasets
  ...
  {:rdf/about        :voaf/occurrencesInDatasets,
   :rdf/type         :owl/DatatypeProperty,
   :rdfs/comment     [{:rdf/language "fr",
                       :rdf/value
...
(def occurrencesInVocabularies
  ...
  {:rdf/about        :voaf/occurrencesInVocabularies,
   :rdf/type         :owl/DatatypeProperty,
   :rdfs/comment     [{:rdf/language "fr",
                       :rdf/value
  ...
  {:rdf/about :voaf/reliesOn,
   ...
   :rdfs/label [{:rdf/language "fr",
                ...
                {:rdf/language "en",
                 :rdf/value    "relies on"}],
   :rdfs/range :voaf/Vocabulary,
   :rdfs/subPropertyOf ["http://rdfs.org/ns/void#vocabulary"
                        :dcterms/references],
   :vs/term_status "stable"})

(def reusedByDatasets
  "Distinct number of datasets reusing a resource."
  {:rdf/about :voaf/reusedByDatasets,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   [{:rdf/language "fr",
...
(def reusedByVocabularies
  ...
  {:rdf/about :voaf/reusedByVocabularies,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   [{:rdf/language "fr",
