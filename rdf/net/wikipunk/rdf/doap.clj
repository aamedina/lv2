...
(def developer-forum
  ...
  {:rdf/about        :doap/developer-forum,
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value
                      "A forum or community for developers of this project."},
...
(def security-contact
  ...
  {:rdf/about :doap/security-contact,
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def security-policy
  ...
  {:rdf/about          :doap/security-policy,
   :rdf/type           :rdf/Property,
   :rdfs/comment       {:rdf/language "en",
